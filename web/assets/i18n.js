...
const I18N = {
  en: {
    ...
    f_brain_t:"Swappable brains", f_brain_d:"Run each agent on its own model — 19 providers built in: Claude/GLM/DeepSeek/Qwen/MiniMax/Kimi/Kimi Code direct, OpenAI/Gemini/OpenRouter/NVIDIA/Groq/Cerebras/xAI/Mistral/Together/Fireworks via a built-in zero-dependency proxy (no LiteLLM), and local Ollama/LM Studio with no API key. Pickers fetch live model lists; auto-compact keeps long chats from clogging on any model.",
  ...
  de: {
    ...
    f_brain_d:"Betreiben Sie jeden Agent mit seinem eigenen Modell — 19 Anbieter integriert: Claude/GLM/DeepSeek/Qwen/MiniMax/Kimi/Kimi Code direkt, OpenAI/Gemini/OpenRouter/NVIDIA/Groq/Cerebras/xAI/Mistral/Together/Fireworks über einen integrierten abhängigkeitsfreien Proxy (kein LiteLLM) sowie lokales Ollama/LM Studio ohne API-Schlüssel. Auswahlfelder rufen live Modelllisten ab; Auto-Compact verhindert, dass lange Chats bei jedem Modell verstopfen.",
  ...
  th: {
    ...
    f_brain_t:"สมองสลับได้", f_brain_d:"ให้ agent แต่ละตัวใช้คนละโมเดล — 19 provider ในตัว: Claude/GLM/DeepSeek/Qwen/MiniMax/Kimi/Kimi Code ต่อตรง, OpenAI/Gemini/OpenRouter/NVIDIA/Groq/Cerebras/xAI/Mistral/Together/Fireworks ผ่าน proxy ในตัว (ไม่ต้องลง LiteLLM), และ Ollama/LM Studio ในเครื่องไม่ต้องใช้ key · ดึงรายชื่อโมเดลสด + auto-compact กันคุยยาวจนตันทุกโมเดล",
